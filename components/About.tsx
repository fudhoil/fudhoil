...
const About = (props: Props) => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col relative h-screen text-center md:text-align md:flex-row max-w-7xl px-10 justify-center md:justify-evenly mx-auto items-center">
